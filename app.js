...
function resetContent() {
    textOutput.innerHTML = '<img src="./assets/gato.png" alt="aaa">' +
                           '<h1>Nenhuma mensagem encontrada</h1>' +
                           '<h3>Digite um texto que você deseja criptografar ou descriptografar.</h3>';
}

function alert01(){
    alert('Por favor, digite uma mensagem que você deseja criptografar primeiro.');
}

function alert02(){
    alert('Por favor, digite uma mensagem que você deseja descriptografar primeiro.');
}
